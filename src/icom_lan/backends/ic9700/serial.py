...
class Ic9700SerialRadio(Icom7610CoreRadio):
    ...
    # Delegate audio driver lifecycle methods to support parent class contract
    async def _ensure_audio_started(self) -> None:
        """Called by parent to ensure audio is running; serial driver self-manages."""
        pass

    async def _ensure_audio_stopped(self) -> None:
        """Called by parent to ensure audio is stopped; serial driver self-manages."""
        pass
