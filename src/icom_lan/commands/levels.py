...
from ._builders import _build_level_get, _build_level_set, _build_ctl_mem_get, _build_ctl_mem_set
...
def set_rf_gain(
    ...
    if receiver != RECEIVER_MAIN:
        return build_cmd29_frame(
            to_addr, from_addr, _CMD_LEVEL, sub=_SUB_RF_GAIN, data=bcd, receiver=receiver,
        )
...
def set_af_level(
    ...
    if receiver != RECEIVER_MAIN:
        return build_cmd29_frame(
            to_addr, from_addr, _CMD_LEVEL, sub=_SUB_AF_LEVEL, data=bcd, receiver=receiver,
        )
...
def get_squelch(
    ...
    return _build_level_get(
        _SUB_SQL, to_addr=to_addr, from_addr=from_addr, receiver=receiver,
        command29=(receiver != RECEIVER_MAIN), cmd_map=cmd_map, cmd_name="get_squelch",
    )
...
def set_squelch(
    ...
    if cmd_map is not None:
        return _build_from_map(
            cmd_map, "set_squelch", to_addr=to_addr, from_addr=from_addr,
            data=_level_bcd_encode(level), receiver=receiver,
            command29=(receiver != RECEIVER_MAIN),
        )
    bcd = _level_bcd_encode(level)
    if receiver != RECEIVER_MAIN:
...
def get_apf_type_level(
    ...
    return _build_level_get(_SUB_APF_TYPE_LEVEL, to_addr=to_addr, from_addr=from_addr,
        receiver=receiver, command29=True, cmd_map=cmd_map, cmd_name="get_apf_type_level")


def set_apf_type_level(
    level: int, to_addr: int, from_addr: int = CONTROLLER_ADDR,
    receiver: int = RECEIVER_MAIN, cmd_map: CommandMap | None = None,
) -> bytes:
    """Build a set APF Type Level command."""
    return _build_level_set(_SUB_APF_TYPE_LEVEL, level, to_addr=to_addr, from_addr=from_addr,
        receiver=receiver, command29=True, cmd_map=cmd_map, cmd_name="set_apf_type_level")
...
def get_nr_level(
    ...
    return _build_level_get(_SUB_NR_LEVEL, to_addr=to_addr, from_addr=from_addr,
        receiver=receiver, command29=True, cmd_map=cmd_map, cmd_name="get_nr_level")
...
def set_nr_level(
    ...
    return _build_level_set(_SUB_NR_LEVEL, level, to_addr=to_addr, from_addr=from_addr,
        receiver=receiver, command29=True, cmd_map=cmd_map, cmd_name="set_nr_level")
...
def get_pbt_inner(
    ...
    return _build_level_get(_SUB_PBT_INNER, to_addr=to_addr, from_addr=from_addr,
        receiver=receiver, command29=True, cmd_map=cmd_map, cmd_name="get_pbt_inner")
...
def set_pbt_inner(
    ...
    return _build_level_set(_SUB_PBT_INNER, level, to_addr=to_addr, from_addr=from_addr,
        receiver=receiver, command29=True, cmd_map=cmd_map, cmd_name="set_pbt_inner")
...
def get_pbt_outer(
    ...
    return _build_level_get(_SUB_PBT_OUTER, to_addr=to_addr, from_addr=from_addr,
        receiver=receiver, command29=True, cmd_map=cmd_map, cmd_name="get_pbt_outer")
...
def set_pbt_outer(
    ...
    return _build_level_set(_SUB_PBT_OUTER, level, to_addr=to_addr, from_addr=from_addr,
        receiver=receiver, command29=True, cmd_map=cmd_map, cmd_name="set_pbt_outer")
...
def get_cw_pitch(
    ...
    return _build_level_get(_SUB_CW_PITCH, to_addr=to_addr, from_addr=from_addr,
        cmd_map=cmd_map, cmd_name="get_cw_pitch")


def set_cw_pitch(
    pitch_hz: int, to_addr: int, from_addr: int = CONTROLLER_ADDR,
    cmd_map: CommandMap | None = None,
) -> bytes:
    """Build a set CW Pitch command."""
    return _build_level_set(_SUB_CW_PITCH, _cw_pitch_to_level(pitch_hz),
        to_addr=to_addr, from_addr=from_addr, cmd_map=cmd_map, cmd_name="set_cw_pitch")
...
def get_mic_gain(
    ...
    return _build_level_get(_SUB_MIC_GAIN, to_addr=to_addr, from_addr=from_addr,
        cmd_map=cmd_map, cmd_name="get_mic_gain")
...
def set_mic_gain(
    ...
    return _build_level_set(_SUB_MIC_GAIN, level, to_addr=to_addr, from_addr=from_addr,
        cmd_map=cmd_map, cmd_name="set_mic_gain")
...
def get_key_speed(
    ...
    return _build_level_get(_SUB_KEY_SPEED, to_addr=to_addr, from_addr=from_addr,
        cmd_map=cmd_map, cmd_name="get_key_speed")


def set_key_speed(
    wpm: int, to_addr: int, from_addr: int = CONTROLLER_ADDR,
    cmd_map: CommandMap | None = None,
) -> bytes:
    """Build a set Key Speed command."""
    return _build_level_set(_SUB_KEY_SPEED, _key_speed_to_level(wpm),
        to_addr=to_addr, from_addr=from_addr, cmd_map=cmd_map, cmd_name="set_key_speed")
...
def get_notch_filter(
    ...
    return _build_level_get(_SUB_NOTCH_FILTER, to_addr=to_addr, from_addr=from_addr,
        cmd_map=cmd_map, cmd_name="get_notch_filter")
...
def set_notch_filter(
    ...
    return _build_level_set(_SUB_NOTCH_FILTER, level, to_addr=to_addr, from_addr=from_addr,
...
def get_compressor_level(
    ...
    return _build_level_get(_SUB_COMPRESSOR_LEVEL, to_addr=to_addr, from_addr=from_addr,
        cmd_map=cmd_map, cmd_name="get_compressor_level")
...
def set_compressor_level(
    ...
    return _build_level_set(_SUB_COMPRESSOR_LEVEL, level, to_addr=to_addr, from_addr=from_addr,
...
def get_break_in_delay(
    ...
    return _build_level_get(_SUB_BREAK_IN_DELAY, to_addr=to_addr, from_addr=from_addr,
        cmd_map=cmd_map, cmd_name="get_break_in_delay")
...
def set_break_in_delay(
    ...
    return _build_level_set(_SUB_BREAK_IN_DELAY, level, to_addr=to_addr, from_addr=from_addr,
...
def get_nb_level(
    ...
    return _build_level_get(_SUB_NB_LEVEL, to_addr=to_addr, from_addr=from_addr,
        receiver=receiver, command29=True, cmd_map=cmd_map, cmd_name="get_nb_level")
...
def set_nb_level(
    ...
    return _build_level_set(_SUB_NB_LEVEL, level, to_addr=to_addr, from_addr=from_addr,
        receiver=receiver, command29=True, cmd_map=cmd_map, cmd_name="set_nb_level")
...
def get_digisel_shift(
    ...
    return _build_level_get(_SUB_DIGISEL_SHIFT, to_addr=to_addr, from_addr=from_addr,
        receiver=receiver, command29=True, cmd_map=cmd_map, cmd_name="get_digisel_shift")
...
def set_digisel_shift(
    ...
    return _build_level_set(_SUB_DIGISEL_SHIFT, level, to_addr=to_addr, from_addr=from_addr,
        receiver=receiver, command29=True, cmd_map=cmd_map, cmd_name="set_digisel_shift")
...
def get_drive_gain(
    ...
    return _build_level_get(_SUB_DRIVE_GAIN, to_addr=to_addr, from_addr=from_addr,
        cmd_map=cmd_map, cmd_name="get_drive_gain")
...
def set_drive_gain(
    ...
    return _build_level_set(_SUB_DRIVE_GAIN, level, to_addr=to_addr, from_addr=from_addr,
...
def get_monitor_gain(
    ...
    return _build_level_get(_SUB_MONITOR_GAIN, to_addr=to_addr, from_addr=from_addr,
        cmd_map=cmd_map, cmd_name="get_monitor_gain")
...
def set_monitor_gain(
    ...
    return _build_level_set(_SUB_MONITOR_GAIN, level, to_addr=to_addr, from_addr=from_addr,
...
def get_vox_gain(
    ...
    return _build_level_get(_SUB_VOX_GAIN, to_addr=to_addr, from_addr=from_addr,
        cmd_map=cmd_map, cmd_name="get_vox_gain")
...
def set_vox_gain(
    ...
    return _build_level_set(_SUB_VOX_GAIN, level, to_addr=to_addr, from_addr=from_addr,
        cmd_map=cmd_map, cmd_name="set_vox_gain")
...
def get_anti_vox_gain(
    ...
    return _build_level_get(_SUB_ANTI_VOX_GAIN, to_addr=to_addr, from_addr=from_addr,
        cmd_map=cmd_map, cmd_name="get_anti_vox_gain")
...
def set_anti_vox_gain(
    ...
    return _build_level_set(_SUB_ANTI_VOX_GAIN, level, to_addr=to_addr, from_addr=from_addr,
...
def get_ref_adjust(to_addr: int, from_addr: int = CONTROLLER_ADDR, cmd_map: CommandMap | None = None) -> bytes:
...
def set_ref_adjust(value: int, to_addr: int, from_addr: int = CONTROLLER_ADDR, cmd_map: CommandMap | None = None) -> bytes:
    """Build a set REF Adjust command."""
    if not 0 <= value <= 511:
        raise ValueError(f"REF Adjust must be 0-511, got {value}")
    return _build_ctl_mem_set(_CTL_MEM_REF_ADJUST, value, to_addr=to_addr, from_addr=from_addr, byte_count=2, cmd_map=cmd_map, cmd_name="set_ref_adjust")


def get_dash_ratio(to_addr: int, from_addr: int = CONTROLLER_ADDR, cmd_map: CommandMap | None = None) -> bytes:
...
def set_dash_ratio(value: int, to_addr: int, from_addr: int = CONTROLLER_ADDR, cmd_map: CommandMap | None = None) -> bytes:
    """Build a set Dash Ratio command."""
    if not 28 <= value <= 45:
        raise ValueError(f"Dash Ratio must be 28-45, got {value}")
    return _build_ctl_mem_set(_CTL_MEM_DASH_RATIO, value, to_addr=to_addr, from_addr=from_addr, byte_count=1, cmd_map=cmd_map, cmd_name="set_dash_ratio")


def get_nb_depth(to_addr: int, from_addr: int = CONTROLLER_ADDR, cmd_map: CommandMap | None = None) -> bytes:
...
def set_nb_depth(value: int, to_addr: int, from_addr: int = CONTROLLER_ADDR, cmd_map: CommandMap | None = None) -> bytes:
    """Build a set NB Depth command."""
    if not 0 <= value <= 9:
        raise ValueError(f"NB Depth must be 0-9, got {value}")
    return _build_ctl_mem_set(_CTL_MEM_NB_DEPTH, value, to_addr=to_addr, from_addr=from_addr, byte_count=1, cmd_map=cmd_map, cmd_name="set_nb_depth")


def get_nb_width(to_addr: int, from_addr: int = CONTROLLER_ADDR, cmd_map: CommandMap | None = None) -> bytes:
...
def set_nb_width(value: int, to_addr: int, from_addr: int = CONTROLLER_ADDR, cmd_map: CommandMap | None = None) -> bytes:
    """Build a set NB Width command."""
    if not 0 <= value <= 255:
        raise ValueError(f"NB Width must be 0-255, got {value}")
    return _build_ctl_mem_set(_CTL_MEM_NB_WIDTH, value, to_addr=to_addr, from_addr=from_addr, byte_count=2, cmd_map=cmd_map, cmd_name="set_nb_width")


def get_vox_delay(to_addr: int, from_addr: int = CONTROLLER_ADDR, cmd_map: CommandMap | None = None) -> bytes:
    """Build a read VOX Delay command (0x1A 0x05 0x02 0x92)."""
    return _build_ctl_mem_get(_CTL_MEM_VOX_DELAY, to_addr=to_addr, from_addr=from_addr, cmd_map=cmd_map, cmd_name="get_vox_delay")


def set_vox_delay(value: int, to_addr: int, from_addr: int = CONTROLLER_ADDR, cmd_map: CommandMap | None = None) -> bytes:
    """Build a set VOX Delay command (0x1A 0x05 0x02 0x92)."""
    if not 0 <= value <= 20:
        raise ValueError(f"VOX Delay must be 0-20, got {value}")
    return _build_ctl_mem_set(_CTL_MEM_VOX_DELAY, value, to_addr=to_addr, from_addr=from_addr, byte_count=1, cmd_map=cmd_map, cmd_name="set_vox_delay")
