...
Canonical location: rigplane.runtime._state_queries
...
makes ``rigplane._state_queries`` literally the same module object
as ``rigplane.runtime._state_queries``. This preserves attribute
...
from rigplane.runtime._state_queries import *  # noqa: F401, F403
import rigplane.runtime._state_queries as _canonical
