...
Canonical location: rigplane.runtime._shared_state_runtime
...
makes ``rigplane._shared_state_runtime`` literally the same module
object as ``rigplane.runtime._shared_state_runtime``. This preserves
...
from rigplane.runtime._shared_state_runtime import *  # noqa: F401, F403
import rigplane.runtime._shared_state_runtime as _canonical
