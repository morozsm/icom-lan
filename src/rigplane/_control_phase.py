...
Canonical location: rigplane.runtime._control_phase
...
makes ``rigplane._control_phase`` literally the same module object as
``rigplane.runtime._control_phase``. This preserves attribute walks
...
from rigplane.runtime._control_phase import *  # noqa: F401, F403
import rigplane.runtime._control_phase as _canonical
