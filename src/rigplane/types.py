...
Canonical location: rigplane.core.types
...
makes ``rigplane.types`` literally the same module object as
``rigplane.core.types``. This preserves attribute walks (incl.
...
* ``sys.modules[__name__] = _canonical`` — the runtime invariant.
  Makes ``rigplane.types`` and ``rigplane.core.types`` the
...
from rigplane.core.types import *  # noqa: F401, F403
import rigplane.core.types as _canonical
