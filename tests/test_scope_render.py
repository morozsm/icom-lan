...
class TestAmplitudeToColor:
    def test_returns_rgb_tuple(self) -> None:
        from rigplane.scope_render import amplitude_to_color
...
class TestThemeSwitching:
    def test_all_themes_render_spectrum(self) -> None:
        from rigplane.scope_render import THEMES, render_spectrum
    ...
    def test_all_themes_render_waterfall(self) -> None:
        from rigplane.scope_render import THEMES, render_waterfall
    ...
    def test_all_themes_render_scope_image(self) -> None:
        from rigplane.scope_render import THEMES, render_scope_image
